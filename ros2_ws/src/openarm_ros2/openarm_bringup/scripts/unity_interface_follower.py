...
MAX_POSITION_RATE = [14.0, 14.0, 5.0, 5.0, 18.0, 18.0, 18.0]  # 各關節最大速度 (rad/s)
...
# 舊值: [1.2, 1.2, 1.5, 1.5, 2.0, 2.0, 2.0]
# [2026-04-08] 1.2x 提速（馬達能力的 32-60%）
# 舊值: [12.0, 12.0, 4.0, 4.0, 15.0, 15.0, 15.0]
#                  DM8009        DM4340        DM4310
#   馬達 VMAX:     45            8             30         rad/s
#   設定佔比:      32%           60%           60%
RUCKIG_MAX_VELOCITY = [14.0, 14.0, 5.0, 5.0, 18.0, 18.0, 18.0]  # rad/s
# 舊值: [40.0, 40.0, 20.0, 20.0, 60.0, 60.0, 60.0]
RUCKIG_MAX_ACCELERATION = [48.0, 48.0, 24.0, 24.0, 72.0, 72.0, 72.0]  # rad/s²
# 舊值: [200.0, 200.0, 100.0, 100.0, 300.0, 300.0, 300.0]
RUCKIG_MAX_JERK = [240.0, 240.0, 120.0, 120.0, 360.0, 360.0, 360.0]  # rad/s³
