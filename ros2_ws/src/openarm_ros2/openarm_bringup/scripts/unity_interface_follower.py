...
# [2026-04-07] 全面提高 KP（參考 LeRobot=240, 官方ROS2=70, 校準腳本=150-300）
#              降低小關節 KD（參考 LeRobot=0.3）
# 舊值 KP: [60.0, 60.0, 25.0, 25.0, 30.0, 30.0, 50.0]
# 舊值 KD: [5.0, 4.5, 1.2, 1.5, 1.0, 1.0, 1.2]
BASE_KP = [150.0, 150.0, 100.0, 100.0, 25.0, 30.0, 25.0]
BASE_KD = [5.0, 5.0, 2.5, 2.5, 0.5, 0.5, 0.5]
...
# [2026-04-07] 提高到與 Ruckig 同步（Ruckig 開啟時此值不生效，僅 fallback 用）
# 舊值: [1.2, 1.2, 1.5, 1.5, 2.0, 2.0, 2.0]
MAX_POSITION_RATE = [12.0, 12.0, 4.0, 4.0, 15.0, 15.0, 15.0]  # 各關節最大速度 (rad/s)
...
# 舊值: [1.2, 1.2, 1.5, 1.5, 2.0, 2.0, 2.0]
# [2026-04-07] 提高到馬達能力的 ~30-50%，讓 Ruckig 響應更快
# 舊值: [6.0, 6.0, 2.5, 2.5, 8.0, 8.0, 8.0]
#                  DM8009      DM4340      DM4310
#   馬達 VMAX:     45          8           30       rad/s
#   設定佔比:      27%         50%         50%
RUCKIG_MAX_VELOCITY = [12.0, 12.0, 4.0, 4.0, 15.0, 15.0, 15.0]  # rad/s
# 舊值: [20.0, 20.0, 15.0, 15.0, 30.0, 30.0, 30.0]
RUCKIG_MAX_ACCELERATION = [40.0, 40.0, 20.0, 20.0, 60.0, 60.0, 60.0]  # rad/s²
# 舊值: [100.0, 100.0, 80.0, 80.0, 150.0, 150.0, 150.0]
RUCKIG_MAX_JERK = [200.0, 200.0, 100.0, 100.0, 300.0, 300.0, 300.0]  # rad/s³
