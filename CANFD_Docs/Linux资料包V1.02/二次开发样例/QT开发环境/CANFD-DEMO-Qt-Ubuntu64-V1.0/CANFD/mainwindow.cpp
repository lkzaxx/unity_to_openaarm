    ...
    ui(new Ui::MainWindow)
{
    ...
    canthread = new CANFDThread();
    connect(canthread,&CANFDThread::recvedCANData,this,&MainWindow::canRecvedCANData);
    connect(canthread,&CANFDThread::recvedCANFDData,this,&MainWindow::canRecvedCANFDData);
}
